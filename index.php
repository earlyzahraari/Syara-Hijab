				...
				<div id="slider-carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						<div class="item">
							<div class="col-sm-6">
								<h1><span>SyaraHijab</span></h1>
								<h2>Inner Basic Tanktop Grey</h2>
								<p>SyaraHijab juga punya inner baju buat bikin ootd kamu makin keren tapi tetep simple.</p>
								<a class="btn btn-default get" style="border:2px solid Black;" href="http://localhost:8080/syarahijab/detail.php?id=40">Beli Sekarang</a>
							</div>
							<div class="col-sm-6">
								<img src="foto_produk/HD3.jpg" class="girl img-responsive" alt="" />
							</div>
						</div>
...
<footer id="footer">
	<div class="footer-bottom">
		<div class="container">
			<div class="row">
				<p class="center-block">Copyright © 2022 SyaraHijab</p>
			</div>
		</div>
	</div>
